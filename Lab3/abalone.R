...
# For now, we’ll break the rings variable # into 3 levels" “young” for abalones less than 8, “adult” for abalones between 8-11, 
...
aba_scaled <- aba
aba_scaled[1:7] <-as.data.frame(lapply(aba_scaled[1:7], normalize))
summary(aba_scaled$shucked_wieght)
